========================================================================
    KONSOLENANWENDUNG: JoystickButtonTimer-Projektübersicht
========================================================================

Diese JoystickButtonTimer-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre JoystickButtonTimer-Anwendung besteht.


JoystickButtonTimer.vcxproj
...
JoystickButtonTimer.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "JoystickButtonTimer.pch und eine 
